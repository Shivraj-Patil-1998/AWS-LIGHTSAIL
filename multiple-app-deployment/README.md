...
---------------To deploy multiple server-----------------------
$ # create the directory inside the /home/bitnami/<directory name>
$ Ex:- htdocs-2    //inside that index.html
$ # create new file 
$ Ex:- index.html


$ # navigate to the apache server root directory
$ /opt/bitnami/apache/conf/httpd.conf

$ # add virtual host
<VirtualHost *:443>
    ServerName <domain name>
    DocumentRoot "/home/bitnami/htdocs-2"
    #after generating SSl certificate generate key file path
    <Directory "/home/bitnami/htdocs-2">
    Require all granted
    </Directory>
    # Other directives here
</VirtualHost>
